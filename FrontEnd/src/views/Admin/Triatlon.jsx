...
import MasInfo from "../../components/MasInfo"; // Asegúrate de importar MasInfo
    ...
    <div className="p-6 md:w-11/12 lg:w-5/6 mx-auto poppins">
      <div className="flex items-center justify-center">
        ...
        <div className="flex flex-col justify-start items-start">
          ...
          <h1 className="text-xl lg:text-5xl md:text-4xl font-bold mt-1 text-center"><span className="text-primary-300">Triatlón</span> Disponibles</h1>
        </div>
      </div>
      ...
      <div>
        <h1 className="text-4xl mt-5 font-bold text-primary-400">Triatlón</h1>
        <div className="w-8/12 md:w-5/12 lg:w-3/12 h-1 bg-primary-0 mb-5"></div>
        <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-4">
          {items
            .filter((comp) => comp.Disciplina === "Triatlon")
            .map((competencia) => (
              <CompetenciaCard
                key={competencia._id}

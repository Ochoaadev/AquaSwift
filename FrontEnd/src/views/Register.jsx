...
const Register = () => {
  ...
  const validateForm = () => {
    const errors = {};
    let errorMessage = ""; // Variable para el mensaje de error específico
    let errorType = ""; // Tipo de modal a mostrar
            ...
            <div className='relative'>
              ...
              >
                <option
                  value=''
                  disabled
                  className='bg-[#FFFFFF] text-[#FFFFFF]'
                >
                  {errors.genero
                ...
                <option
                  value='Masculino'
                  className='text-[#FFFFFF] bg-primary-100'
                >
                  Masculino
                </option>
                <option
